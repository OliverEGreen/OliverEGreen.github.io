...
<article class="post projects">
    ...
    <div class="project">
        ...
        <p>At the inaugural Dynamo Hackathon, I organised a team from four different architectural practices — the Hackstreet Boys. Our goal: build something technologically ambitious while having as much fun as legally possible.</p>
        <p>Assisted by Luke and Keith from the Dynamo development team, we shipped a node package with a live webcam feed inside a node, letting users take a selfie without leaving Dynamo.</p>
        <p>An open-source 3DMM technique (via PyTorch) then generated a mesh representation of the user's face. We came third — and won a special prize for being the most fun team at the event. #BIMSelfie</p>
    </div>
