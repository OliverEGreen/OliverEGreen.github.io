...
<figure>
    ...
    <figcaption>The rebuilt node UI</figcaption>
...
<figure>
    <img src="{{ '/assets/images/projects/dynamo-panels.jpg' | relative_url }}" alt="Three rebuilt Dynamo panels: package search, the hierarchical info/warning/error system and the package publisher">
    <figcaption>Packages, warnings and publishing</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>The new home canvas</figcaption>
</figure>